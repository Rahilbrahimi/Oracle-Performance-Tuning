...
این سند یک راهنمای گام‌به‌گام برای بررسی کامل عملکرد یک دیتابیس Oracle است. هدف، شناسایی گلوگاه‌ها، رفتار نادرست کوئری‌ها، ساختار ناسازگار دیتابیس و ارائه پیشنهادهای بهینه‌سازی است.

## 🎯 ساختار کلی تحلیل Performance

بررسی عملکرد دیتابیس را می‌توان در سه لایه اصلی دسته‌بندی کرد:
...
## 📋 پیشنهاد ترتیب اجرای مراحل بررسی
